      ...
      <div style={{ color: "white" }}>
        ...
        <div className="card-container">
          <div className="card-image">
            <p>{/* <img src={rize} alt="" width="100%" /> */}</p>
          </div>
        ...
        <div className="card-container">
          <div className="card-image">
            <p>{/* <img src={requia} alt="" width="100%" /> */}</p>
          </div>
        ...
        <div className="card-container">
          <div className="card-image">
            <p>{/* <img src={kolt} alt="" width="100%" /> */}</p>
          </div>
        ...
        <div className="card-container">
          <div className="card-image">
            <p>{/* <img src={damien} alt="" width="100%" /> */}</p>
          </div>
        ...
        <div className="card-container">
          <div className="card-image">
            <p>{/* <img src={hunter} alt="" width="100%" /> */}</p>
          </div>
